...
public class Calculadora {
    ...
    public static double[] calculos(int a, int b, double c) {
        double[] resultados = new double[3];
        resultados[0] = (a * 2) * ((double) b / 2);
        resultados[1] = (a * 3) + c;
        resultados[2] = Math.pow(c, 3);
        return resultados;
    }
    ...
    public static Map<String, Double> excessoPeso(double peso) {
        Map<String, Double> resultado = new HashMap<>();
        if (peso > 50) {
            double excesso = peso - 50;
            double multa = excesso * 4;
            resultado.put("excesso", excesso);
            resultado.put("multa", multa);
        } else {
    ...
    public static Map<String, Double> lojaTintas(double area) {
        Map<String, Double> resultado = new HashMap<>();
        double litros = area / 3;
        double latas = Math.ceil(litros / 18);
        double preco = latas * 80;
        resultado.put("latas", latas);
